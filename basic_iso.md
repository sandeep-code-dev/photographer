...
![Aperture](./file_pictures/iso.png)

### ISO Guide to all digital cameras.

<https://www.youtube.com/watch?v=n2HSoOq-rfo>

Unlike shutter speed and aperture which controls the physical mechanics of the camera, ISO works is digital (ISO Internationl organization for standarization)

It refers to senstivity of camera image sensor to light (Simple words adding exposure digitally)

ISO is measured in numbers 100, 200, 400 and so on.

- Lower the iso number the less sensitive the camera sensor to the light and less noice in the image there will be.
- Higher iso will make your image brighter but it also increase the amount of noice in the image.
- It is very similar to the amount to brightness in editing software. You tend to see good amount of noice and pixelation.
- You should typically use a lower iso in bright situations such as sunny outdoor shooting.
- And higher iso in lower light situations. But keep in mind as you increase iso image will become grainy or noicy. I typically try to stay below 800 and sometime you have to increase it and there are software to fix the high iso in editing.
- To avoid noice and grain first adjust aperture and shutter speed then worry about iso.

To find out if your image is properly exposed
most of the cameras have handy little chart called histogram.

![histogram](./file_pictures/iso2.png)
...
![histogram example](./file_pictures/iso3.png)
